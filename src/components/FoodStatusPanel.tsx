  ...
  return (
    <Card className="shadow-sm">
      ...
      <CardContent className="space-y-4">
        ...
        {/* Warmth status */}
        {warmthStatus.isCold && (
          <div className="p-3 rounded-lg border-2 bg-blue-50 border-blue-200 dark:bg-blue-900/10 dark:border-blue-800">
            ...
            <div className="flex items-center gap-3 text-xs">
              {warmthStatus.hasBonfire ? (
                <Badge variant="outline" className="border-orange-600 text-orange-600 dark:text-orange-400">
                  <Flame className="w-3 h-3 mr-1" />
                  篝火
                </Badge>
              ) : (
                <Badge variant="outline" className="border-gray-500 text-gray-500 dark:text-gray-600">
                  <Flame className="w-3 h-3 mr-1" />
                  无篝火
                </Badge>
              )}
            ...
            {!warmthStatus.hasBonfire && !warmthStatus.isClothed && (
              <Alert className="mt-2">
                <AlertDescription className="text-xs text-red-600 dark:text-red-400 font-bold">
                  ⚠️ 极度危险！食物消耗翻倍！
                </AlertDescription>
              </Alert>
            )}
